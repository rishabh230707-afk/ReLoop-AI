...
def serve(port=8765, state_path=None, open_browser=True):
        ...
        def do_GET(self):
            ...
            try:
                ...
                if route == '/api/bootstrap':
                    ...
                    self.send({'token':token, 'partners':read_json(ROOT/'partners.json'), 'inventory':state['inventory'], 'summary':summary(state), 'transfers':state['transfers']}); return
...
if __name__ == '__main__':
    ...
    try: serve(args.port,args.state,not args.no_browser)
